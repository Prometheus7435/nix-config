{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-76d05512-55ff-4462-a6e8-f3dbfb98d7b9" = [ ];
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."76d05512-55ff-4462-a6e8-f3dbfb98d7b9" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "76d05512-55ff-4462-a6e8-f3dbfb98d7b9";
      "kcminputrc"."Libinput.6127.24757.Chicony ThinkPad X1 Tablet Thin Keyboard Gen 3"."NaturalScroll" = true;
      "kcminputrc"."Libinput.6127.24757.Chicony ThinkPad X1 Tablet Thin Keyboard Gen 3"."TapToClick" = true;
      ...
      "kdeglobals"."WM"."activeBlend" = "46,52,64";
      "kdeglobals"."WM"."activeForeground" = "236,239,244";
      "kdeglobals"."WM"."inactiveBackground" = "46,52,64";
      "kdeglobals"."WM"."inactiveBlend" = "46,52,64";
      "kdeglobals"."WM"."inactiveForeground" = "216,222,233";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{c38543e5-1db9-45a7-bf6e-cd4239bbfa08}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{fbe09a52-ad6e-4536-a6cf-c78f618fcf49}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{c23cdcbe-69a0-4606-a57b-82131b20144e}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{5cee7842-6ff0-4ba7-88f4-0b1572a4894a}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{db0fe631-4c04-4e64-90d7-f0b8c627cf99}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{b7d09d1b-f3a1-4827-b3c9-a202f311ea46}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{db9f1dbe-2ee1-4b37-92c9-871b5d2d034d}";
      ...
      "kwinrc"."Desktops"."Id_1" = "7c71424a-ebdc-49fd-96bd-fe19d087dc71";
      "kwinrc"."Desktops"."Id_2" = "bac391eb-96f0-4d99-94c7-ad2bea3a24fa";
      "kwinrc"."Desktops"."Id_3" = "9e6b81d1-a870-4fdf-8686-8c012a0fc972";
...
}
{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "kwin"."Window One Desktop Down" = "Meta+Ctrl+Shift+Down";
      "kwin"."Window One Desktop Up" = "Meta+Ctrl+Shift+Up";
      "kwin"."Window One Desktop to the Left" = "Meta+Ctrl+Left";
      "kwin"."Window One Desktop to the Right" = "Meta+Ctrl+Shift+Right";
      "kwin"."Window One Screen Down" = [ ];
      "kwin"."Window One Screen Up" = [ ];
      "kwin"."Window One Screen to the Left" = [ ];
    ...
    files = {
      ...
      "kactivitymanagerdrc"."main"."currentActivity" = "76d05512-55ff-4462-a6e8-f3dbfb98d7b9";
      "kcminputrc"."Libinput.6127.24757.Chicony ThinkPad X1 Tablet Thin Keyboard Gen 3"."NaturalScroll" = true;
      "kcminputrc"."Libinput.6127.24757.Chicony ThinkPad X1 Tablet Thin Keyboard Gen 3"."PointerAcceleration" = 0.800;
      "kcminputrc"."Libinput.6127.24757.Chicony ThinkPad X1 Tablet Thin Keyboard Gen 3"."PointerAccelerationProfile" = 1;
      "kcminputrc"."Libinput.6127.24757.Chicony ThinkPad X1 Tablet Thin Keyboard Gen 3"."TapToClick" = true;
      "kcminputrc"."Libinput.6127.24757.Chicony ThinkPad X1 Tablet Thin Keyboard Gen 3 Consumer Control"."NaturalScroll" = true;
      "kcminputrc"."Tmp"."update_info" = "delete_cursor_old_default_size.upd:DeleteCursorOldDefaultSize";
      "kded5rc"."Module-browserintegrationreminder"."autoload" = false;
      "kded5rc"."Module-device_automounter"."autoload" = false;
      "kded5rc"."PlasmaBrowserIntegration"."shownCount" = 1;
      ...
      "kdeglobals"."General"."fixed" = "Source Code Pro,10,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."WM"."activeFont" = "Noto Sans Myanmar,10,-1,5,50,0,0,0,0,0";
      ...
      "kwinrc"."Desktops"."Number" = 3;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-magiclamp"."AnimationDuration" = 170;
      "kwinrc"."Effect-overview"."TouchBorderActivate" = 0;
      "kwinrc"."Effect-windowview"."BorderActivateAll" = 9;
      "kwinrc"."Effect-windowview"."TouchBorderActivate" = 6;
      ...
      "kwinrc"."Tiling"."padding" = 3;
      "kwinrc"."Tiling.6dbfdb1c-0d23-5013-9b2c-a432872102bb"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"layoutDirection\":\"vertical\",\"tiles\":[{\"height\":0.5},{\"height\":0.5}],\"width\":0.4},{\"width\":0.6}]}";
      "kwinrc"."Wayland"."InputMethod[$e]" = "/run/current-system/sw/share/applications/org.fcitx.Fcitx5.desktop";
      ...
      "kxkbrc"."Layout"."VariantList" = "dvorak,";
      "plasma-localerc"."Formats"."LANG" = "en_US.UTF-8";
      "plasmarc"."Wallpapers"."usersWallpapers" = "/home/shyfox/.local/share/wallpapers/32832-moononlake.jpg,/home/shyfox/.local/share/wallpapers/Mars Starry Night HD Wallpaper.jpg";
    };
  };
}
