{
  programs.plasma = {
    ...
    configFile = {
      ...
      "kcminputrc"."Libinput.6127.24757.Chicony ThinkPad X1 Tablet Thin Keyboard Gen 3"."PointerAcceleration" = 0.800000;
      ...
      "kdeglobals"."KDE"."AnimationDurationFactor" = 0.707107;
